        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div>
            <ul className="flex space-x-4 mr-[10pc] gap-[30px]">
              ...
              <li>
                <a href="#about" className="hover:underline">Update
                </a>
              </li>
              <li>
                <a href="#services" className="hover:underline">Services
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:underline"> Fearture
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:underline">About us
                </a>
              </li>
            </ul>
          </div>
